...
public abstract class ResourceServer {
    ...
    /**
     * A replacement for Request.getParameter() as it will mess up with HTTP POST body
     * @param request
     * @param name
     * @return
     */
    public static String[] getQueryParameterValues(Request request, String name) {
    ...
    public static String getQueryParameterValue(Request request, String name) {
