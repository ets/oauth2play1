...
import oauth2.as.validator.CodeValidator;
import oauth2.as.validator.TokenValidator;
...
import oauth2.common.message.types.ResponseType;
...
public class OAuthAuthzRequest extends OAuthRequest {
    ...
    public OAuthAuthzRequest(Http.Request request) throws OAuthSystemException, OAuthProblemException {
        super(request);
    }

    @Override
    protected OAuthValidator<Http.Request> initValidator() throws OAuthProblemException, OAuthSystemException {
        ...
        Class<? extends OAuthValidator<Http.Request>> clazz = validators.get(requestTypeValue);
        if (clazz == null) {
